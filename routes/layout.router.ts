...
FaqRouter.post("/create-layout",isAuthenticated,authorizeRoles('admin'),createLayout);           
FaqRouter.put("/edit-layout",isAuthenticated,authorizeRoles('admin'),EditLayout);           
